...
return new class extends Migration
{
    ...
    {
        Schema::create('tr_kode_jenis_pengawasan', function (Blueprint $table) {
            $table->char('kode_jenis_pengawasan', 2)->index()->primary();
    ...
    {
        Schema::dropIfExists('tr_kode_jenis_pengawasan');
    }
};
