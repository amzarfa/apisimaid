...
return new class extends Migration
{
    ...
    {
        Schema::create('tr_kode_kabupatenkota', function (Blueprint $table) {
            $table->char('kode_kabkota', 4)->index()->primary();
            $table->char('kode_provinsi', 2)->index();
            $table->string('nama_kabkota')->nullable();
            $table->char('jenis_kabkota', 20)->nullable();
    ...
    {
        Schema::dropIfExists('tr_kode_kabupatenkota');
    }
};
